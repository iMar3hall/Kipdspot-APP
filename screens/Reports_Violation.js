...
const Reports_Violation = ({ navigation }) => {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Reports_Violation Screen</Text>
        <Text style={styles.text}>Here you can manage your Reports_Violation.</Text>
      </View>
    </SafeAreaView>
  );
};
...
export default Reports_Violation;